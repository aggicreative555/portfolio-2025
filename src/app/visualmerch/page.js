...
export const metadata = {
  ...
  title: "Aggi Cieplak | Visual Merch Portfolio",
  description: "Hi, I'm a junior Visual Merchandiser working at UFF Bergen, who curates displays that drive sales.",
  openGraph: {
    title: "Aggi Cieplak | Visual Merch Portfolio",
    description: "Hi, I'm a junior Visual Merchandiser working at UFF Bergen, who curates displays that drive sales.",
...
export default function VisualMerch() {
  return (
    <>
      <div className="mx-4 md:mx-0 dark:bg-red-900 dark:text-white">
        <div className="container mx-auto">
          <div className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 md:px-12 md:py-16 lg:py-8">
            <div className="lg:flex lg:justify-between lg:gap-4">
              <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-[48%] lg:flex-col lg:justify-between lg:py-24 mr-8">
                <div className="flex flex-col gap-4 font-garamond cursor-default lg:w-md">
                    <ModeButtons/>
                  <HandwritingAnimation/>
                  <FadeInText as='h2' delay={0.2} className='mt-3 text-lg tracking-wider sm:text-xl uppercase' >
                    Visual Merchandiser
                  </FadeInText>
                  <FadeInText as='p' delay={0.4} className='mt-4' >
                    I build creative, practical and structured experiences for the web. 
                  </FadeInText>
                  <FadeInText as='p' delay={0.2} className='w-sm'>
