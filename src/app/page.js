        ...
        <div className="container mx-auto">
          <div className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 md:px-12 md:py-16 lg:py-8">
            <div className="lg:flex lg:justify-between lg:gap-4">
              <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-[48%] lg:flex-col lg:py-24 lg:pr-30">
                <div className="flex flex-col gap-4 font-garamond cursor-default">
                  <HandwritingAnimation/>
                  <SvgStack/>
                  <FadeInText as='h2' delay={0.2} className='mt-8 text-lg tracking-wider sm:text-xl uppercase' >
                    JUNIOR FRONTEND DEV
                  </FadeInText>
              ...
              <main className="pt-24 lg:w-[52%] lg:py-24">
                <section className="mb-16 scroll-mt-16 md:mb-10 lg:mb-20 lg:scroll-mt-24" aria-label="About me" id='about'>
                  ...
                  <div className="font-garamond tracking-wider cursor-default space-y-4">
                    <FadeInText as='p' delay={0.2}>
                      I am passionate about building <span aria-hidden='true' className="font-semibold   duration-300">creative, </span><span  aria-hidden='true' className="font-semibold   duration-300">practical </span>and<span  aria-hidden='true' className="font-semibold   duration-300"> structured</span> experiences for the web. The best part of my work lies in the intersection between design and development, creating designs that are not only <span  aria-hidden='true' className="font-semibold   duration-300"> uniquely aesthetic</span> but are also crafted for <span  aria-hidden='true' className="font-semibold  duration-300"> performance </span> and <span  aria-hidden='true' className="font-semibold   duration-300"> usability</span>.
                    </FadeInText>
                    <FadeInText as='p' delay={0.4}>
                      I am currently a <span  aria-hidden='true' className="font-semibold   duration-300"> Visual Merchandiser</span> at UFF, where I craft user experiences on-site. I contribute to the visual touchpoints of our store and drive sales by using <span  aria-hidden='true' className="font-semibold   duration-300">UX principles</span> and  <span aria-hidden='true' className="font-semibold   duration-300">design thinking</span> to create delightful experiences. 
                    </FadeInText>
                    <FadeInText as='p' delay={0.8}>
                      During my UX and Front-end studies, I had a professional UI project for STO Medical,<span  aria-hidden='true' className="font-semibold   duration-300"> building wireframes and digital assets.</span> Later, I was a development intern at StudVest where we <span  aria-hidden='true' className="font-semibold   duration-300">debugged</span> the website and created fun <span  aria-hidden='true' className="font-semibold   duration-300">games</span> for students to experience. In my free time I love to <span  aria-hidden='true' className="font-semibold   duration-300">design & crochet, </span>or indulge in any kind of artistic endeavor. 
                    </FadeInText>
                ...
                <section className="font-garamond mb-16 scroll-mt-16 md:mb-20 lg:mb-30 lg:scroll-mt-24" aria-label="School projects" id='projects'>
                  <div className="sticky top-0 z-20 -mx-6 mb-4 w-screen px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
