    ...
    return (
        <motion.ul 
            ...
            <motion.li 
                ...
                variants={item}>
            <Link className="block hover:text-red-800 transition-all duration-300" href='https://github.com/aggicreative555' rel="noopener noreferrer" target="_blank" aria-label="GitHub (opens in a new tab)" title="GitHub"> 
            ...
            <motion.li 
                className="mr-5 shrink-0 text-xs"
                variants={item}>
            <Link className="block hover:text-red-800 transition-all duration-300" href='https://www.linkedin.com/in/aggi-cieplak/' rel="noopener noreferrer" target="_blank" aria-label="Linkedin (opens in a new tab)" title="Linkedin"> 
                <span className="sr-only"></span>
            ...
            <motion.li 
                className="mr-5 shrink-0 text-xs"
                variants={item}>
            <Link className="block hover:text-red-800 transition-all duration-300" href='https://www.behance.net/aggic#' target="_blank" rel="noopener noreferrer" aria-label="Behance (opens in a new tab)" title="Behance"> 
                <span className="sr-only"></span>
